...
function addCounter(table, idx, name, data) {
  ...
  button1.setAttribute("style", 
    "font-size: 20px; padding: 8px 16px; border: 2px solid red; border-radius: 4px; cursor: pointer;");
  ...
  button2.setAttribute("style",
    "font-size: 20px; padding: 8px 16px; border: 2px solid green; border-radius: 4px; cursor: pointer;");
